...
<?php 		
	...
	function getSkinPro(){
		if (!isset($_GET['cat'])) {
			...
			$get_pro = "SELECT * FROM products WHERE featured = 0 AND deleted = 0 AND cat_name = 'skin-care'";
...
<?php 		
	...
	function getHairPro(){
		if (!isset($_GET['cat'])) {
			...
			$get_pro = "SELECT * FROM products WHERE featured = 0 AND deleted = 0 AND cat_name = 'hair-care'";
			$run_pro = mysqli_query($db, $get_pro);
...
<?php 		
	...
	function getBodyPro(){
		if (!isset($_GET['cat'])) {
			...
			$get_pro = "SELECT * FROM products WHERE featured = 0 AND deleted = 0 AND cat_name = 'body-care'";
			$run_pro = mysqli_query($db, $get_pro);
...
<?php 		
	...
	function getBath_BeautyPro(){
		if (!isset($_GET['cat'])) {
			...
			$get_pro = "SELECT * FROM products WHERE featured = 0 AND deleted = 0 AND cat_name = 'bath-and-beauty'";
			$run_pro = mysqli_query($db, $get_pro);
