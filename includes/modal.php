	...
	<div class="modal fade details-1" id="details-modal" tabindex="-1" role="dialog" aria-labelledby="details-1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background: #6b5523;color: #fff;">								
								...
								<form action="add_cart.php" method="post" id="add_product_form">
									...
									<div class="form-group">
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<input type="number" name="quantity" class="form-control" id="quantity" value=1 min=1 style="border:none; border-bottom: 1px solid #3b465e;width: 70px;">
										</div>
									</div>
									<div class="stock">
										<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<br>
				<div class="modal-footer" style="background: #c0a567">
					<a href="description.php?pro_id=<?= $product['id']; ?>" class="btn white-text" style="background: #6b5523;border-radius: 10em;" title="View Product">View Product</a>
					<button class="btn white-text" style="background: #6b5523;border-radius: 10em;" title="Add to Cart" onclick="add_to_cart();">Add to Cart &nbsp;<span class="fa fa-shopping-cart"></span></button>
				</div>
			</div>
		</div>
	</div>
