        ...
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-md-10">
              ...
              <hr class="hr-light">
              <h4 class="white-text my-4 h1-responsive" style="font-family: 'Cookie', cursive;">Checkout Now</h4>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <h2 class="text-center h2-responsive px-3 py-3"><b>Checkout Form</b></h2>
        ...
        <div>
          ...
          <div>
            <?php if(!$hash) { ?>
              <button type="submit" class="btn" style="background: #6b5523;border-radius: 10em">Submit</button>
            <?php } ?>
          </div>
        </form>
      </div>
