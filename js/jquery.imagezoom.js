...
(function ($) {
  ...
  $.fn.zoom = function (action) {
    ...
    if (action === 'reset') {
      ...
      this.append($('<div class="jsZoomMouse" style="display: none; position: absolute; height: 250px; width: 250px; z-index: 9999; border-radius: 200px; background-repeat: no-repeat;"/>'));
